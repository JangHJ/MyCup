...
import com.yours.mycup.databinding.FragmentRecordEndTimeBottomSheetBinding
import com.google.android.material.bottomsheet.BottomSheetDialogFragment
import java.time.LocalDateTime

class RecordEndTimeBottomSheetFragment : BottomSheetDialogFragment() {

    interface onEndTimePassListener {
        fun onEndDataPass(data : String?)
    }
    lateinit var endTimePassListener : onEndTimePassListener
    ...
    override fun onAttach(context: Context) {
        ...
        endTimePassListener = context as onEndTimePassListener
    }
    ...
    override fun onCreateView(
        ...
        val binding = FragmentRecordEndTimeBottomSheetBinding.inflate(inflater, container, false)
        ...
        binding.saveButtonDatepicker.setOnClickListener {
            val end = "${hour.value}시 ${minute.value}분"
            endTimePassListener.onEndDataPass(end)
